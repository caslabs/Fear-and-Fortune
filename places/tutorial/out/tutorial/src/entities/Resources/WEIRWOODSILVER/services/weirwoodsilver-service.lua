...
Reflect.defineMetadata(WeirwoodSilverComponent, "identifier", "tutorial/src/entities/Resources/WEIRWOODSILVER/services/weirwoodsilver-service@WeirwoodSilverComponent")
Reflect.defineMetadata(WeirwoodSilverComponent, "flamework:parameters", { "tutorial/src/systems/InventorySystem/services/inventory-system-service@InventorySystemService" })
