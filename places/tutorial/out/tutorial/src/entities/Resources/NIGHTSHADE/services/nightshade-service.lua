...
Reflect.defineMetadata(NightShadeComponent, "identifier", "tutorial/src/entities/Resources/NIGHTSHADE/services/nightshade-service@NightShadeComponent")
Reflect.defineMetadata(NightShadeComponent, "flamework:parameters", { "tutorial/src/systems/InventorySystem/services/inventory-system-service@InventorySystemService" })
