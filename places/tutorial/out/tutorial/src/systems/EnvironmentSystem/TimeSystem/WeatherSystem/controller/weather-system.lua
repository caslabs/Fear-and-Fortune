...
Reflect.defineMetadata(WeatherSystemController, "identifier", "tutorial/src/systems/EnvironmentSystem/TimeSystem/WeatherSystem/controller/weather-system@WeatherSystemController")
Reflect.defineMetadata(WeatherSystemController, "flamework:parameters", { "tutorial/src/mechanics/PlayerMechanics/CharacterMechanic/controller/character-controller@CharacterMechanic" })
