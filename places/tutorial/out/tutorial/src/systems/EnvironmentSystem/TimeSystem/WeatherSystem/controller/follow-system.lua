...
Reflect.defineMetadata(FollowAgentSystemController, "identifier", "tutorial/src/systems/EnvironmentSystem/TimeSystem/WeatherSystem/controller/follow-system@FollowAgentSystemController")
Reflect.defineMetadata(FollowAgentSystemController, "flamework:parameters", { "tutorial/src/mechanics/PlayerMechanics/CharacterMechanic/controller/character-controller@CharacterMechanic" })
