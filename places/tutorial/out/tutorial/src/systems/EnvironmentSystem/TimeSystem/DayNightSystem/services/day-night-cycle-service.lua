...
Reflect.defineMetadata(DayNightCycleService, "identifier", "tutorial/src/systems/EnvironmentSystem/TimeSystem/DayNightSystem/services/day-night-cycle-service@DayNightCycleService")
