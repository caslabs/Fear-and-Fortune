...
Reflect.defineMetadata(AtmosphereService, "identifier", "tutorial/src/systems/EnvironmentSystem/TimeSystem/AtmosphereSystem/services/atmosphere-service@AtmosphereService")
