...
do
	...
	function MusicSystemController:playMusic(id)
...
Reflect.defineMetadata(MusicSystemController, "identifier", "tutorial/src/systems/AudioSystem/MusicSystem/controller/music-controller@MusicSystemController")
