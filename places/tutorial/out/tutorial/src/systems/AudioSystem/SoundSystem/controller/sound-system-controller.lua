...
Reflect.defineMetadata(SoundSystemController, "identifier", "tutorial/src/systems/AudioSystem/SoundSystem/controller/sound-system-controller@SoundSystemController")
