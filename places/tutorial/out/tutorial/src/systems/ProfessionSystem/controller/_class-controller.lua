...
Reflect.defineMetadata(ClassController, "identifier", "tutorial/src/systems/ProfessionSystem/controller/_class-controller@ClassController")
Reflect.defineMetadata(ClassController, "flamework:parameters", { "tutorial/src/mechanics/PlayerMechanics/UIMechanic/controller/hud-controller@HUDController", "tutorial/src/mechanics/PlayerMechanics/CameraMechanic/controller/camera-controller@CameraMechanic" })
