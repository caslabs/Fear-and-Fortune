...
do
	...
	function TaskSystemService:onStart()
		...
		-- Complete Objective
		CompleteObjectiveEvent:SetCallback(function(player)
			taskManager:completeObjective()
		end)
	end
end
-- (Flamework) TaskSystemService metadata
Reflect.defineMetadata(TaskSystemService, "identifier", "tutorial/src/systems/TaskSystem/services/task-service@TaskSystemService")
