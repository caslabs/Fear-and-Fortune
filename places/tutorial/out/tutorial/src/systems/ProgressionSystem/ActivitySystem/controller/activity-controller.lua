...
Reflect.defineMetadata(ElevationMechanicController, "identifier", "tutorial/src/systems/ProgressionSystem/ActivitySystem/controller/activity-controller@ElevationMechanicController")
