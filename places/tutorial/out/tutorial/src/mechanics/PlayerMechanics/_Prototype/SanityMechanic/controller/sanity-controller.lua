...
do
	...
	function SanityMechanicController:onStart()
		...
		ContextActionService:BindAction("DecreaseSanity", function(_, state)
...
Reflect.defineMetadata(SanityMechanicController, "identifier", "tutorial/src/mechanics/PlayerMechanics/_Prototype/SanityMechanic/controller/sanity-controller@SanityMechanicController")
