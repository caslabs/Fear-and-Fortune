...
Reflect.defineMetadata(MouseController, "identifier", "tutorial/src/mechanics/PlayerMechanics/UIMechanic/controller/mouse-controller@MouseController")
Reflect.defineMetadata(MouseController, "flamework:parameters", { "tutorial/src/mechanics/PlayerMechanics/CharacterMechanic/controller/character-controller@CharacterMechanic" })
