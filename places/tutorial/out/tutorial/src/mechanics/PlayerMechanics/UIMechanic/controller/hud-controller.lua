...
Reflect.defineMetadata(HUDController, "identifier", "tutorial/src/mechanics/PlayerMechanics/UIMechanic/controller/hud-controller@HUDController")
Reflect.defineMetadata(HUDController, "flamework:parameters", { "tutorial/src/mechanics/PlayerMechanics/CameraMechanic/controller/camera-controller@CameraMechanic", "tutorial/src/mechanics/PlayerMechanics/CharacterMechanic/controller/character-controller@CharacterMechanic", "tutorial/src/mechanics/PlayerMechanics/UIMechanic/controller/mouse-controller@MouseController" })
