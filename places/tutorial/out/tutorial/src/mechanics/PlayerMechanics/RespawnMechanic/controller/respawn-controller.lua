...
Reflect.defineMetadata(RespawnMechanic, "identifier", "tutorial/src/mechanics/PlayerMechanics/RespawnMechanic/controller/respawn-controller@RespawnMechanic")
Reflect.defineMetadata(RespawnMechanic, "flamework:parameters", { "tutorial/src/mechanics/PlayerMechanics/LifeMechanic/controller/life-controller@LifeMechanic" })
