...
Reflect.defineMetadata(CameraMechanic, "identifier", "tutorial/src/mechanics/PlayerMechanics/CameraMechanic/controller/camera-controller@CameraMechanic")
Reflect.defineMetadata(CameraMechanic, "flamework:parameters", { "tutorial/src/mechanics/PlayerMechanics/CharacterMechanic/controller/character-controller@CharacterMechanic" })
