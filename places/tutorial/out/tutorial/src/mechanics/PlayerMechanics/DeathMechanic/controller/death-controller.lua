...
Reflect.defineMetadata(DeathMechanic, "identifier", "tutorial/src/mechanics/PlayerMechanics/DeathMechanic/controller/death-controller@DeathMechanic")
Reflect.defineMetadata(DeathMechanic, "flamework:parameters", { "tutorial/src/systems/AudioSystem/MusicSystem/controller/music-controller@MusicSystemController" })
