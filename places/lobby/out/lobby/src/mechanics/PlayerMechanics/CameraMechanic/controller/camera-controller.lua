...
do
	...
	function CameraMechanic:enableLobbyCamera()
...
Reflect.defineMetadata(CameraMechanic, "identifier", "lobby/src/mechanics/PlayerMechanics/CameraMechanic/controller/camera-controller@CameraMechanic")
Reflect.defineMetadata(CameraMechanic, "flamework:parameters", { "lobby/src/mechanics/PlayerMechanics/CharacterMechanic/controller/character-controller@CharacterMechanic" })
