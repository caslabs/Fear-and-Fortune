...
Reflect.defineMetadata(CharacterMechanic, "identifier", "lobby/src/mechanics/PlayerMechanics/CharacterMechanic/controller/character-controller@CharacterMechanic")
