...
local _Context_TitleHUD = TS.import(script, script.Parent.Parent, "routers", "Title", "Context-TitleHUD")
local Context = _Context_TitleHUD.Context
local Pages = _Context_TitleHUD.Pages
local Panel = TS.import(script, script.Parent.Parent, "Pages", "Panels", "PanelTitle", "Panel").Panel
...
local SplashScreen = TS.import(script, script.Parent.Parent, "screens", "splash-screen")
local TitleHUD = function(props, _param)
	...
	return Roact.createElement(Context.Consumer, {
		render = function(value)
			return Roact.createElement(Panel, {
				...
				Roact.createElement(SplashScreen),
				Roact.createElement("Frame", {
					...
					Roact.createElement("TextLabel", {
						...
						Text = "SEASON 1 - THE YETI OF MOUNT EVEREST",
...
local default = Hooks.new(Roact)(TitleHUD)
return {
	default = default,
}
