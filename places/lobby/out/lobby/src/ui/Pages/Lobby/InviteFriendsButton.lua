...
local InviteFriendsButton = function(props, _param)
	local useState = _param.useState
	local buttonText, setButtonText = useState("Invite Friends")
	return Roact.createFragment({
		InviteFriendsButton = Roact.createElement("Frame", {
			Size = UDim2.fromScale(0.1, 0.045),
			Position = UDim2.new(0.1, 0, 0.011, 0),
...
local default = Hooks.new(Roact)(InviteFriendsButton)
return {
	default = default,
}
