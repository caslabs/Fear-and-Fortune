...
local TwitterButton = function(props, _param)
	local useState = _param.useState
	local buttonText, setButtonText = useState("Twitter")
	return Roact.createElement(Context.Consumer, {
		render = function(value)
			return Roact.createFragment({
				TwitterButton = Roact.createElement("Frame", {
					Size = UDim2.fromScale(0.1, 0.045),
					Position = UDim2.new(0.22, 0, 0.011, 0),
...
local default = Hooks.new(Roact)(TwitterButton)
return {
	default = default,
}
