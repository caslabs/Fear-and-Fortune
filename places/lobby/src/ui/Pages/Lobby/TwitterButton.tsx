...
const TwitterButton: Hooks.FC<TwitterProp> = (props, { useState }) => {
	const [buttonText, setButtonText] = useState("Twitter");
	return (
		<Context.Consumer
			render={(value: { viewIndex: number; setPage: (index: number) => void }) => {
				return (
					<frame
						...
						Position={new UDim2(0.22, 0, 0.011, 0)}
...
export default new Hooks(Roact)(TwitterButton);
