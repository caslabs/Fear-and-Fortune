...
import { tradeInventoryList, itemValues } from "./data/_TradeData";
import { InventoryItemData } from "../../data/_inventoryData";

interface PocketCatProps {
	isVisible: boolean;
...
const PocketCat: Hooks.FC<PocketCatProps> = (props, { useState, useEffect }) => {
	const [data, setData] = useState<Array<InventoryItemData>>([]);
	const [tradeData, settradeData] = useState<Array<InventoryItemData>>(tradeInventoryList); // New state for backpack data
...
export default new Hooks(Roact)(PocketCat);
