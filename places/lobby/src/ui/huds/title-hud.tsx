...
import { Context, Pages } from "ui/routers/Title/Context-TitleHUD";
import { Panel } from "ui/Pages/Panels/PanelTitle/Panel";
...
const TitleHUD: Hooks.FC<TitleScreenProps> = (props, { useState, useEffect }) => {
	...
	return (
		<Context.Consumer
			render={(value: { viewIndex: number; setPage: (index: number) => void }) => {
				return (
					<Panel index={Pages.title} visible={props.visible}>
						<SplashScreen />
						<frame
...
export default new Hooks(Roact)(TitleHUD);
