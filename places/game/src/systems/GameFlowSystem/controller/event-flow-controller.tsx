...
import { DayNightCycleController } from "systems/EnvironmentSystem/TimeSystem/DayNightSystem/controller/day-night-cycle-controller";
...
export class EventFlowController implements OnStart {
	...
	constructor(
		...
		private readonly dayNightCycleController: DayNightCycleController,
	) {
