...
Reflect.defineMetadata(BadgeObserver, "identifier", "game/src/systems/BadgeSystem/services/BadgeObserver@BadgeObserver")
Reflect.defineMetadata(BadgeObserver, "flamework:parameters", { "game/src/systems/BadgeSystem/services/BadgeManager@BadgeManagerService" })
