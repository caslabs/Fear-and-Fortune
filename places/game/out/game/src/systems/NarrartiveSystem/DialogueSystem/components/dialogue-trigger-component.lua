...
Reflect.defineMetadata(DialogueTriggerComponent, "identifier", "game/src/systems/NarrartiveSystem/DialogueSystem/components/dialogue-trigger-component@DialogueTriggerComponent")
