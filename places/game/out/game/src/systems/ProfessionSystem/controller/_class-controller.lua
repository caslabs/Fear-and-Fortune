...
Reflect.defineMetadata(ClassController, "identifier", "game/src/systems/ProfessionSystem/controller/_class-controller@ClassController")
Reflect.defineMetadata(ClassController, "flamework:parameters", { "game/src/mechanics/PlayerMechanics/UIMechanic/controller/hud-controller@HUDController", "game/src/mechanics/PlayerMechanics/CameraMechanic/controller/camera-controller@CameraMechanic" })
