...
Reflect.defineMetadata(ElevationMechanicController, "identifier", "game/src/systems/ProgressionSystem/ElevationSystem/controller/elevation-controller@ElevationMechanicController")
Reflect.defineMetadata(ElevationMechanicController, "flamework:parameters", { "game/src/mechanics/PlayerMechanics/CharacterMechanic/controller/character-controller@CharacterMechanic" })
