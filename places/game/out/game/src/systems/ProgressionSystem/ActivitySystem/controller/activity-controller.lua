...
Reflect.defineMetadata(ElevationMechanicController, "identifier", "game/src/systems/ProgressionSystem/ActivitySystem/controller/activity-controller@ElevationMechanicController")
