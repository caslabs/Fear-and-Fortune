...
local AIPsychologicalScareManager
do
	AIPsychologicalScareManager = setmetatable({}, {
		__tostring = function()
			return "AIPsychologicalScareManager"
		end,
	})
	AIPsychologicalScareManager.__index = AIPsychologicalScareManager
	function AIPsychologicalScareManager.new(...)
		local self = setmetatable({}, AIPsychologicalScareManager)
		return self:constructor(...) or self
	end
	function AIPsychologicalScareManager:constructor(playerStateController)
		self.playerStateController = playerStateController
		self.eventManager = EventManager:getInstance()
	end
	function AIPsychologicalScareManager:getInstance(playerStateController)
		if not self.instance then
			self.instance = AIPsychologicalScareManager.new(playerStateController)
		end
		return self.instance
	end
	function AIPsychologicalScareManager:isFirstPerson(playerCamera)
	...
	function AIPsychologicalScareManager:createJumpscareAgent(agent)
	...
	function AIPsychologicalScareManager:findNearestPlayer(agent, minDistanceToChase)
...
return {
	AIPsychologicalScareManager = AIPsychologicalScareManager,
}
