...
Reflect.defineMetadata(SanityMechanicService, "identifier", "game/src/mechanics/PlayerMechanics/_Prototype/SanityMechanic/services/sanity-service@SanityMechanicService")
