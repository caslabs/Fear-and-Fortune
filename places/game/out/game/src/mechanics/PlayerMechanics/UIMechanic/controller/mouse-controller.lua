...
Reflect.defineMetadata(MouseController, "identifier", "game/src/mechanics/PlayerMechanics/UIMechanic/controller/mouse-controller@MouseController")
Reflect.defineMetadata(MouseController, "flamework:parameters", { "game/src/mechanics/PlayerMechanics/CharacterMechanic/controller/character-controller@CharacterMechanic" })
