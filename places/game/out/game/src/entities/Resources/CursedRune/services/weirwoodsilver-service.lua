...
Reflect.defineMetadata(WeirwoodSilverComponent, "identifier", "game/src/entities/Resources/CursedRune/services/weirwoodsilver-service@WeirwoodSilverComponent")
