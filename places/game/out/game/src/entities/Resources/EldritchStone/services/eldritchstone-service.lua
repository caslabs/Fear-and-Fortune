...
do
	...
	function EldritchStoneComponent:grab(player)
		...
		self.inventorySystem:addItemToInventory(player, "EldritchStones")
		print("[INFO] Grabbing Ladder")
		self.instance:Destroy()
	end
end
-- (Flamework) EldritchStoneComponent metadata
Reflect.defineMetadata(EldritchStoneComponent, "identifier", "game/src/entities/Resources/EldritchStone/services/eldritchstone-service@EldritchStoneComponent")
Reflect.defineMetadata(EldritchStoneComponent, "flamework:parameters", { "game/src/systems/InventorySystem/services/inventory-system-service@InventorySystemService" })
