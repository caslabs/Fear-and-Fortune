...
Reflect.defineMetadata(IronWoodComponent, "identifier", "game/src/entities/Resources/IronWood/services/ironwood-service@IronWoodComponent")
Reflect.defineMetadata(IronWoodComponent, "flamework:parameters", { "game/src/systems/InventorySystem/services/inventory-system-service@InventorySystemService" })
