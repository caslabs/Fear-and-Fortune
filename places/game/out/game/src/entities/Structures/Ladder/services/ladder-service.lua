...
Reflect.defineMetadata(LadderComponent, "identifier", "game/src/entities/Structures/Ladder/services/ladder-service@LadderComponent")
Reflect.defineMetadata(LadderComponent, "flamework:parameters", { "game/src/systems/InventorySystem/services/inventory-system-service@InventorySystemService" })
