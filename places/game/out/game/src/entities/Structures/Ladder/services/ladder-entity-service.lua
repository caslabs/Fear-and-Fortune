...
Reflect.defineMetadata(InteractiveLadderComponent, "identifier", "game/src/entities/Structures/Ladder/services/ladder-entity-service@InteractiveLadderComponent")
Reflect.defineMetadata(InteractiveLadderComponent, "flamework:parameters", { "game/src/systems/InventorySystem/services/inventory-system-service@InventorySystemService" })
